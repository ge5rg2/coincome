...
- [절대 규칙 3 - symbol 형식] symbol은 반드시 "코인명/KRW" 형태로 작성하라. (예: ETH/KRW, SOL/KRW) "ETH", "KRW-ETH" 등 다른 형식은 시스템 오류를 일으킨다.
- [절대 규칙 4 - 숫자 형식] target_profit_pct와 stop_loss_pct는 % 기호나 +/- 부호 없이 순수 숫자만 적어라. (예: 1.8 ← 올바름 / "+1.8%" ← 오류)
...
[올바른 응답 예시 — 이 형식을 반드시 따를 것]
{
  ...
  "picks": [
    {"symbol": "ETH/KRW", "reason": "1h RSI 63, 거래대금 급증하며 MA20 돌파 — 모멘텀 진입", "target_profit_pct": 1.8, "stop_loss_pct": 1.5},
    {"symbol": "SOL/KRW", "reason": "1h RSI 65, 전고점 돌파 시도 중 — 추세 가속", "target_profit_pct": 2.0, "stop_loss_pct": 1.5}
  ]
}
"""
