...
class PaperEngineSelect(discord.ui.Select):
    ...
    def __init__(self, current_engine: str) -> None:
        ...
        super().__init__(
            placeholder="[모의투자] 가동 엔진 모드를 선택하세요", options=options, row=1
        )
...
class PaperAllEnginesModal(discord.ui.Modal, title="🎮 [모의] [통합] 3엔진 동시 가동 설정"):
    ...
    def __init__(
        ...
        self.major_budget = discord.ui.TextInput(
            ...
            placeholder="예: 5000000  |  [모의투자] 최소 1,000,000 원",
            min_length=7,
            max_length=12,
