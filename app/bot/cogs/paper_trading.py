...
class PaperSettingView(discord.ui.View):
    ...
    def __init__(self, user: User) -> None:
        ...
        if current_engine not in ("SWING", "SCALPING", "BOTH", "MAJOR"):
...
class PaperSwingSettingsModal(discord.ui.Modal, title="🎮 [모의투자] 알트 스윙 (4h) 설정"):
...
class PaperScalpSettingsModal(discord.ui.Modal, title="🎮 [모의투자] 알트 스캘핑 (1h) 설정"):
...
class PaperBothSettingsModal(discord.ui.Modal, title="🎮 [모의투자] 동시 가동 (알트 스윙+알트 스캘핑) 설정"):
