...
> **기준일**: 2026-03-22 (최종 수정: 2026-03-22 — AI 트레이딩 코어 V2 아키텍처 개편 완료 · SWING/SCALPING/BOTH 모듈형 엔진)
> **현재 작업 브랜치**: `backtest`
...
매시 정각 실행 (00:00~23:00, 24회/일)
  ai_engine_mode 분기:
    ...
    BOTH     유저: SWING(스윙 시간대) + SCALPING(매시) 독립 실행
...
| `ai_engine_mode`                        | String(10)      | `"SWING"`  | 가동 엔진: SWING / SCALPING / BOTH                         |
